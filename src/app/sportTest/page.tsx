        ...
        {question ? (
          ...
          currentQuestionId === '14' && (
            ...
            <div className="flex flex-col gap-y-4">
              ...
              <p>
                Своевременные обследования — залог безопасности и эффективности тренировок. Наши эксперты, включая врача олимпийских сборных, создали «Спортивный чекап». Он включает только необходимые анализы и исследования, чтобы:
              </p>
              ...
              <p>Пройдите онлайн-анкетирование и получите персональные рекомендации. Занимайтесь спортом безопасно и результативно!</p>
              <div className="flex items-center justify-end">
                <Button
                  className="bg-[#1D7CBC] hover:bg-[#1D7CBC]/[0.8] border-none"
                  onClick={() => {
