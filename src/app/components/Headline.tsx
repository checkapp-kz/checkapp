...
const Headline = () => {
  ...
  return (
    <section className="lg:container lg:mx-auto lg:py-8 py-0">
          ...
          {CarouselList.map((item, index) => (
            <CarouselItem key={index} className="relative">
              ...
              <div className={cn(
                ...
                <Button
                  className="bg-transparent border border-white w-fit rounded-lg hover:border-[#519B8E] hover:bg-[#519B8E] hover:drop-shadow-md transition ease-in-out delay-150 text-base font-medium"
                >
                  Узнать подробнее
                </Button>
              </div>
