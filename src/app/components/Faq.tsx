  ...
  const faqList = [
    {
      ...
      text: (
        <div className="flex flex-col gap-y-0.5 text-[#4B5162]">
          ...
          <p>2. Пройти анкетирование для формирования персонализированного чекам-пакета.</p>
          <p>3. Оплатить чекап-пакет по удаленно выставленному счету.</p>
          <p>4. Пройти обследование в удобном для вас месте либо обратиться в наши лаборатории-партнеры.</p>
        </div>
      )
    },
    {
      id: 2,
      title: 'Окончательная ли стоимость пакета?',
      text: (
    ...
    },
    {
      ...
      text: (
        <div className="flex flex-col gap-y-2 text-[#4B5162]">
          ...
          <p>
            CheckApp также провел верификацию врачей, выбрав лучших из них. С нами вы можете пройти обследование без лишних временных и финансовых трат.
          </p>
          <p>
